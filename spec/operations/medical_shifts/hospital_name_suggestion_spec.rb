...
RSpec.describe MedicalShifts::HospitalNameSuggestion, type: :operation do
  describe "#call" do
    ...
    context "when there are names stored" do
      ...
      before do
        create(:medical_shift, user: user, hospital_name: "City Hospital")
        create(:medical_shift, user: user, hospital_name: "County Hospital")
        create(:medical_shift, user: user, hospital_name: "City Hospital") # Duplicate name
        create(:medical_shift, user: another_user, hospital_name: "City Hospital Two")
      end
