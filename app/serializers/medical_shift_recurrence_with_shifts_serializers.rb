...
class MedicalShiftRecurrenceWithShiftsSerializer < ActiveModel::Serializer
  attributes :id,
    :frequency,
    :day_of_week,
    :day_of_month,
    ...
    :shifts_generated_count,
    :user_id

  def shifts_generated_count
    @instance_options[:shifts_count] || 0
  end
